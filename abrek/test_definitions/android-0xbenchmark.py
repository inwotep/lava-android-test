...
class ZeroXBenchmarkTestParser(abrek.testdef.AbrekTestParser):
...
streamrun = abrek.testdef.AbrekTestRunner(RUNSTEPS, copysteps=COPYSTEPS)
streamparser = ZeroXBenchmarkTestParser()
testobj = abrek.testdef.AbrekTest(testname="android-0xbenchmark", installer=streaminst,
