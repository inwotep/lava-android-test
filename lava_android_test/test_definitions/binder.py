...
"""
This is a simple test to ensure binder native benchmark test can be run
on an Android build.

**Default Options:** -n 10
"""
...
test_name = 'binder'
DEFAULT_OPTIONS = '-n 10'
config = get_config()
curdir = os.path.realpath(os.path.dirname(__file__))
test_sh_name = 'binder.sh'
...
INSTALL_STEPS_ADB_PRE = ['push %s %s ' % (test_sh_path, test_sh_android_path),
