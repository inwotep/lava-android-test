...
juice_monkey_blacklist_path = os.path.join(curdir, test_name, juice_monkey_blacklist_name)
...
testobj = lava_android_test.testdef.AndroidTest(testname=test_name,
                        installer=inst, runner=run, parser=parser, default_options=DEFAULT_OPTIONS)
