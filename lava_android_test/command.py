...
class AndroidTestCmd(object):
    ...
    def __init__(self, name_prefix=''):
        ...
        self.parser = _OptionParser(usage=self._usage(),
                                         epilog=self._desc())
    ...
    def _usage(self):
        usagestr = "Usage: lava_android_test %s" % self.name()
...
class AndroidTestCmdWithSubcommands(AndroidTestCmd):
    ...
    def _usage(self):
        usagestr = AndroidTestCmd._usage(self)
...
def get_all_cmds():
    from lava_android_test import builtins, dashboard, results
